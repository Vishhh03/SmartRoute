"""
Train all 6 models including LSTM and save comprehensive results
"""
...
print("=" * 80)
print("SMARTROUTE: Training All Models (Traditional ML + Deep Learning)")
print("=" * 80)
...
# Prepare features and target
# Drop date column (it's not a numeric feature) and target column
...
# Save to CSV
output_path = 'results/model_comparison_with_lstm.csv'
